 ...
 * Custom Login Logo
 */
add_action('login_head', 'jjp_themes_custom_login_logo');
function jjp_themes_custom_login_logo() {
	echo '<style type="text/css">
	.login h1 a { background-image: url('.get_bloginfo('template_directory').'/images/jjp-logo.svg) !important; background-size:contain !important; height:70px !important; width:100% !important; }
	</style>';
}

add_filter( 'login_headerurl', 'jjp_themes_custom_login_url' );
function jjp_themes_custom_login_url($url) {
	return '';
}
 ...
 * Custom Favicon
 */
add_action('admin_head','jjp_themes_favicon');
function jjp_themes_favicon(){
